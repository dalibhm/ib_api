...
class KafkaResponseManager(ResponseManager):
    ...
    def process_historical_data(self, requestId: int, bar_data: BarData):
        self.historical_data_processor.produce_msg(requestId, bar_data)

    def process_historical_data_end(self, requestId: int, start: str, end: str):
        self.historical_data_end_processor.produce_msg(requestId, start, end)

    def process_historical_error(self, requestId: int, errorCode: int, errorString: str):
        self.historical_data_end_processor.produce_msg(requestId, '19000101', '19000101')
