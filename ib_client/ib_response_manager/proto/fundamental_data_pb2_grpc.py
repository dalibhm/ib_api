...
import fundamental_data_pb2 as fundamental__data__pb2
...
class FundamentalDataStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetLatestFinancialReportDate = channel.unary_unary(
        ...
        request_serializer=fundamental__data__pb2.LatestFinancialReportRequest.SerializeToString,
...
def add_FundamentalDataServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'GetLatestFinancialReportDate': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=fundamental__data__pb2.LatestFinancialReportRequest.FromString,
