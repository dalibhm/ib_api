...
from _external import contract_details_pb2
from _external import contract_details_pb2_grpc
...
class GrpcContractDetailsProcessor(ContractDetailsProcessor):
    ...
    def process_data(self, request_id, request, contract_details):
        ...
        contract_details = contract_details_pb2.ContractDetails(**contract_details_dict)
        try:
