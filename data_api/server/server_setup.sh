...
git config --global user.email "mohamedali.benhamouda@gmail.com"
git config --global user.name "Mohamed Ali Ben Hamouda"
...
cp /apps/ib_api/ib_python/data_api/server/data_api.service /etc/systemd/system/data_api.service
...
cp /apps/ib_api/ib_python/data_api/server/pypi.nginx /etc/nginx/sites-enabled/pypi.nginx
