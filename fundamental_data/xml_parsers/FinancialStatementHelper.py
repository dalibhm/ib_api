    ...
    for _period in _periods:
        ...
        for _statement in _period:
            ...
            if statement_type != 'BAL':
                ...
                if _period_type:
                    statement_info['period_type'] = (_period_type.attrib['Code'],
                                                     _period_type.text)
                # print(period_length)
            statement_info['update_type'] = (_pfheader.find('UpdateType').attrib['Code'],
            ...
            try:
                ...
                statement_info['auditor_name'] = (_auditor_name.attrib['Code'],
                                                  _auditor_name.text)
                statement_info['auditor_opinion'] = (_pfheader.find('AuditorOpinion').attrib['Code'],
