...
#                 self.ib_client.request_fundamental_data(self.contract, report_type)
#                 sleep(0.5)
#         elif self.request_template.type == RequestType.Historical:
#             self.ib_client.request_historical_data(self.contract, self.request_template.params)
#         else:
